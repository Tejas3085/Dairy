...
@Component({
  selector: 'app-user-plan-detail-list',
  templateUrl: './user-plan-detail-list.component.html',
  styleUrls: ['./user-plan-detail-list.component.css']
})
export class UserPlanDetailListComponent implements OnInit {
  isEdit : boolean;
